...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (calendar)</title>
	...
	<!-- page specific stylesheets -->
		...
		<!-- full calendar -->
		<link rel="stylesheet" href="assets/lib/fullcalendar/fullcalendar/fullcalendar.css">
				...
				<div class="container-fluid">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="sepH_b">
								Select language: <select id='lang-selector'></select>
							</div>
							<div id="calendar_basic"></div>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">JSON Events</div>
						<div class="panel-body">
	...
	<!-- page specific plugins -->
		...
		<script src="assets/lib/fullcalendar/fullcalendar/lang/all.js"></script>
		
		<!-- calendar functions -->
		<script src="assets/js/apps/tisa_calendar.js"></script>
