...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (ecommerce_sales_report)</title>
    ...
    <body>
		...
		<div id="main_wrapper">
			<div class="page_bar clearfix">
				<div class="row">
					<div class="col-md-6">
						<h1 class="page_title">Sales Report</h1>
								...
								<div class="panel-body panel_body_a">
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												<td>Dolor perferendis.</td>
												<td>$18,421.00</td>
											</tr>
											<tr>
												<td>Odit facilis et.</td>
												<td>$15,823.00</td>
											</tr>
											<tr>
												<td>Aspernatur reiciendis.</td>
												<td>$10,967.00</td>
											</tr>
											<tr>
												<td>Voluptate dolores reiciendis.</td>
												<td>$6,071.00</td>
											</tr>
											<tr>
												<td>Saepe explicabo.</td>
												<td>$3,233.00</td>
											</tr>
											<tr>
												<td>Dolores ut est.</td>
												<td>$2,100.00</td>
											</tr>
											<tr>
												<td>Et provident rerum.</td>
												<td>$1,083.00</td>
											</tr>
											<tr>
												<td>Tempore natus.</td>
											...
											<tr>
												<td>Voluptatem blanditiis veniam.</td>
												<td>$583.00</td>
											</tr>
										</tbody>
									</table>
