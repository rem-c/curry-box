...
<div class="login_container">
    <form id="login_form" action="dashboard.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control input-lg" value="User" name="login_username">
        </div>
        <div class="form-group">
            <label for="login_password">Password</label>
            <input type="password" class="form-control input-lg" value="password" name="login_password">
    ...
    <form id="register_form" style="display:none">
        ...
        <span style="color:darkred;">This page is not yet ready. Please email mwalker.web@gmail.com with a request.</span><br/><br/>
        <div class="form-group">
