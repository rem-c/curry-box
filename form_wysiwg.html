...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (form_wysiwg)</title>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading">Full toolbar</div>
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore tempore dolore dolor fugiat vitae praesentium nesciunt minima vel eaque maiores laborum velit iusto unde consequuntur eos quae excepturi quod. Delectus.
							...
							<div class="panel panel-default">
								<div class="panel-heading">Inline editing</div>
								<div class="panel_body_a">
									<h2 contenteditable="true" class="sepH_a">Editable Headline</h2>
									<div class="row">
										<div class="col-lg-6">
											<div contenteditable="true">
												...
												<ul>
													...
													<li>est blanditiis eligendi molestias veniam</li>
												</ul>
												Voluptatum optio velit sequi aliquam deserunt mollitia culpa modi ea ad sunt officiis nihil voluptatibus reprehenderit rerum nam corporis quidem maxime iste.
											</div>
										</div>
										<div class="col-lg-6">
											<div contenteditable="true">
												<blockquote>
													<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima distinctio at nihil odit quae harum suscipit eligendi aspernatur ipsum illum tempore vel sit molestiae explicabo commodi! Tenetur sapiente ipsa earum?</p>
												</blockquote>
												Lorem ipsum dolor sit amet, consectetur adipisicing elit. <strong>Voluptatum optio velit sequi</strong> aliquam deserunt mollitia culpa modi ea ad sunt officiis nihil voluptatibus reprehenderit rerum nam corporis quidem maxime iste.
												Labore a fuga <a href="http://ckeditor.com">porro dolor maxime</a> in doloribus libero neque soluta nulla esse quidem sint? Illum perspiciatis quisquam cumque libero nihil enim?
											</div>
										</div>
									</div>
								</div>
	...
	<!-- page specific plugins -->
		...
		<!-- wizard functions -->
		<script src="assets/js/apps/tisa_wysiwg.js"></script>
