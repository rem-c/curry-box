...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (grid)</title>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-body grid_visual">
									<div class="row">
										<div class="col-md-2"><span class="text-muted">.col-md-2</span></div>
										<div class="col-md-2"><span class="text-muted">.col-md-2</span></div>
										<div class="col-md-2"><span class="text-muted">.col-md-2</span></div>
										<div class="col-md-2"><span class="text-muted">.col-md-2</span></div>
										<div class="col-md-2"><span class="text-muted">.col-md-2</span></div>
									...
									<div class="row">
										<div class="col-md-3"><span class="text-muted">.col-md-3</span></div>
										<div class="col-md-4"><span class="text-muted">.col-md-4</span></div>
										<div class="col-md-3"><span class="text-muted">.col-md-3</span></div>
										<div class="col-md-2"><span class="text-muted">.col-md-2</span></div>
									</div>
									<div class="row">
										<div class="col-md-6"><span class="text-muted">.col-md-6</span></div>
										<div class="col-md-6"><span class="text-muted">.col-md-6</span></div>
									</div>
									<div class="row">
										<div class="col-md-2"><span class="text-muted">.col-md-2</span></div>
										<div class="col-md-8"><span class="text-muted">.col-md-8</span></div>
										<div class="col-md-2"><span class="text-muted">.col-md-2</span></div>
									</div>
									<div class="row">
										<div class="col-md-12"><span class="text-muted">.col-md-12</span></div>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">Offsetting columns</div>
								<div class="panel-body grid_visual">
									<div class="row">
										<div class="col-md-4"><span class="text-muted">.col-md-4</span></div>
										<div class="col-md-4 col-md-offset-4"><span class="text-muted">.col-md-4 .col-md-offset-4</span></div>
									</div>
									<div class="row">
										<div class="col-md-3 col-md-offset-3"><span class="text-muted">.col-md-3 .col-md-offset-3</span></div>
										<div class="col-md-3 col-md-offset-3"><span class="text-muted">.col-md-3 .col-md-offset-3</span></div>
									</div>
									<div class="row">
										<div class="col-md-6 col-md-offset-3"><span class="text-muted">.col-md-6 .col-md-offset-3</span></div>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">Column ordeering</div>
								<div class="panel-body grid_visual">
									<div class="row">
										<div class="col-md-9 col-md-push-3"><span class="text-muted">.col-md-9 .col-md-push-3</span></div>
										<div class="col-md-3 col-md-pull-9"><span class="text-muted">.col-md-3 .col-md-pull-9</span></div>
									</div>
								</div>
							</div>
						</div>
