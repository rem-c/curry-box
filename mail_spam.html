...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (mail_spam)</title>
    ...
    <body>
		...
		<div id="main_wrapper">
			<div class="page_bar clearfix">
				<div class="row">
					<div class="col-sm-8">
						<h1 class="page_title">Spam</h1>
						<p class="text-muted">Lorem ipsum dolor sit...</p>
					</div>
					<div class="col-sm-4 text-right">
						<button class="btn btn-primary"><i class="fa fa-refresh fa_0"></i></button>
						<div class="btn-group text-left">
							<button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button"><i class="fa fa-lg fa-cog"></i> <span class="caret"></span></button>
							<ul class="dropdown-menu dropdown-menu-right">
					...
					<div class="row">
						<div class="col-lg-9">
							<div class="panel panel-default">
								<div class="well well-sm">
									<div class="row">
										...
										<div class="col-lg-8 col-lg-pull-4">
											<div class="btn-group">
												<button class="btn btn-default btn-sm"><span class="fa fa-trash-o"></span> Move to trash</button>
												<button class="btn btn-default btn-sm"><b class="text-danger">Delete forever</b></button>
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														...
														<li><a href="#">Mark as not junk</a></li>
														<li class="divider"></li>
								...
								<table id="mail_spam" class="mail_table table table-hover toggle-arrow-tiny" data-filter="#mailbox_search" data-page-size="20">
									<thead>
										<tr>
									...
									<tbody data-link="row" class="rowlink">
										<tr>
											...
											<td>Providenci Lakin</td>
											<td><a href="#">Commodi dolorum et molestiae nihil saepe.</a></td>
											<td>Feb 5</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[1]" class="check_row" /></td>
											<td>Lizzie Wintheiser IV</td>
											<td><a href="#">Quos animi porro aut earum.</a></td>
											<td>Feb 21</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[2]" class="check_row" /></td>
											<td>Mrs. Marty Wiza III</td>
											<td><a href="#">Tenetur deserunt ea accusamus.</a></td>
											<td>Feb 24</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[3]" class="check_row" /></td>
											<td>Thad Pollich</td>
											<td><a href="#">Corporis doloribus praesentium et doloremque.</a></td>
											<td>Feb 6</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[4]" class="check_row" /></td>
											<td>Miss Marcelo Romaguera Sr.</td>
											<td><a href="#">Facere iure vero.</a></td>
											<td>Feb 18</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[5]" class="check_row" /></td>
											<td>Dr. Emery Quitzon III</td>
											<td><a href="#">Minus adipisci magni pariatur quia.</a></td>
											<td>Feb 5</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[6]" class="check_row" /></td>
											<td>Garry Monahan</td>
											<td><a href="#">Perspiciatis nostrum ea libero.</a></td>
											<td>Feb 25</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[7]" class="check_row" /></td>
											<td>Johnathan Kunde</td>
											<td><a href="#">Illo tempora reiciendis voluptas.</a></td>
											<td>Feb 20</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[8]" class="check_row" /></td>
											<td>Alf Gerhold</td>
											<td><a href="#">Voluptatum dolorum perferendis similique.</a></td>
											<td>Feb 13</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[9]" class="check_row" /></td>
											<td>Mr. Terence Russel MD</td>
											<td><a href="#">Tenetur nihil officiis natus.</a></td>
											<td>Feb 11</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[10]" class="check_row" /></td>
											<td>Florida Gulgowski</td>
											<td><a href="#">Et voluptatibus esse.</a></td>
											<td>Feb 13</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[11]" class="check_row" /></td>
											<td>Turner Pfannerstill</td>
											<td><a href="#">Repellendus adipisci non.</a></td>
											<td>Feb 6</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[12]" class="check_row" /></td>
											<td>Miss Andres Mann</td>
											<td><a href="#">Est sed impedit.</a></td>
											<td>Feb 20</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[13]" class="check_row" /></td>
											<td>Shany Dooley I</td>
											<td><a href="#">Molestiae asperiores sunt magnam accusantium blanditiis.</a></td>
											<td>Feb 20</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[14]" class="check_row" /></td>
											<td>Samantha Kilback</td>
											<td><a href="#">Excepturi fuga et eum voluptate.</a></td>
											<td>Feb 1</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[15]" class="check_row" /></td>
											<td>Jarred Turner</td>
											<td><a href="#">Quia aliquid illum veniam impedit.</a></td>
											<td>Feb 23</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[16]" class="check_row" /></td>
											<td>Josie Metz</td>
											<td><a href="#">Deserunt nostrum tempora perferendis.</a></td>
											<td>Feb 1</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[17]" class="check_row" /></td>
											<td>Ricardo Dare</td>
											<td><a href="#">Odio nobis deserunt eum.</a></td>
											<td>Feb 5</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[18]" class="check_row" /></td>
											<td>Kacie Corkery</td>
											<td><a href="#">Sed atque qui enim tempora.</a></td>
											<td>Feb 3</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[19]" class="check_row" /></td>
											<td>Ms. Heloise Beahan IV</td>
											<td><a href="#">Blanditiis accusamus perferendis quia.</a></td>
											<td>Feb 18</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[20]" class="check_row" /></td>
											<td>Noelia Zulauf</td>
											<td><a href="#">Temporibus aut eligendi.</a></td>
											<td>Feb 14</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[21]" class="check_row" /></td>
											<td>Miss Trystan Stiedemann DVM</td>
											<td><a href="#">Voluptatem eos dolor.</a></td>
											<td>Feb 6</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[22]" class="check_row" /></td>
											<td>Gillian Windler</td>
											<td><a href="#">Est architecto ratione fugit.</a></td>
											<td>Feb 22</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[23]" class="check_row" /></td>
											<td>Thelma Haag</td>
											<td><a href="#">Nulla illo eos.</a></td>
											<td>Feb 9</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[24]" class="check_row" /></td>
											<td>Mathew Monahan</td>
											<td><a href="#">Sit voluptatem ducimus rerum debitis.</a></td>
											<td>Feb 1</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[25]" class="check_row" /></td>
											<td>Elvie Bradtke</td>
											<td><a href="#">Consequuntur iusto sunt maxime fugiat nesciunt.</a></td>
											<td>Feb 10</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[26]" class="check_row" /></td>
											<td>Mortimer Abshire</td>
											<td><a href="#">Natus numquam magnam qui in delectus.</a></td>
											<td>Feb 23</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[27]" class="check_row" /></td>
											<td>Hortense Cole</td>
											<td><a href="#">Odit quidem aut tenetur neque sunt.</a></td>
											<td>Feb 13</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[28]" class="check_row" /></td>
											<td>Theresa Waelchi</td>
											<td><a href="#">Consequuntur at dolore quo eum.</a></td>
											<td>Feb 3</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[29]" class="check_row" /></td>
											<td>Wilhelmine Russel</td>
											<td><a href="#">Quia sed distinctio qui.</a></td>
											<td>Feb 26</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[30]" class="check_row" /></td>
											<td>Ms. Jaqueline Johnston</td>
											<td><a href="#">Et est expedita expedita eveniet.</a></td>
											<td>Feb 25</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[31]" class="check_row" /></td>
											<td>Dr. Arianna Barrows</td>
											<td><a href="#">Esse quibusdam hic sed.</a></td>
											<td>Feb 8</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[32]" class="check_row" /></td>
											<td>Marisol Harber</td>
											<td><a href="#">Eligendi consequatur est incidunt.</a></td>
											<td>Feb 20</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[33]" class="check_row" /></td>
											<td>Miss Tressa Abbott</td>
											<td><a href="#">Dolores quo ut labore.</a></td>
											<td>Feb 23</td>
										</tr>
										<tr>
											<td class="col_sm rowlink-skip"><input type="checkbox" name="check_row[34]" class="check_row" /></td>
											<td>Ova Bahringer</td>
											<td><a href="#">Vel et laudantium harum.</a></td>
											<td>Feb 13</td>
										</tr>
									</tbody>
									<tfoot>
										<tr>
											<td colspan="4">
												<div class="row">
													<div class="col-md-4">
														<span class="mailbox_count_msg"><b class="page_start_row">1</b>-<b class="page_end_row">20</b> of <b class="all_rows">34</b></span>
													</div>
						...
						<div class="col-lg-3">
							<div class="panel panel-default">
								<div class="panel-heading">Spam messages per day</div>
								<div class="panel-body">
									<div id="report_spam_per_day" class="chart" style="height:200px;width:100%">
										<script>
											data_spam = [
												[0,8],
												[1,14],
							...
							<div class="panel panel-default">
								<div class="panel-heading">Top 5 Spammers <a href="#" class="btn btn-xs btn-primary pull-right">Ban all</a></div>
								<div class="panel-body panel_body_a">
									<ul class="list-group list-group-sm">
										
										<li class="list-group-item"><span class="badge badge-danger pull-right">92</span>hartmann.demarcus@hermannwill.com</li>
										
										<li class="list-group-item"><span class="badge badge-danger pull-right">71</span>russ.gerlach@hotmail.com</li>
										
										<li class="list-group-item"><span class="badge badge-danger pull-right">91</span>jacobs.audra@cummerata.biz</li>
										
										<li class="list-group-item"><span class="badge badge-danger pull-right">78</span>ortiz.lexi@gmail.com</li>
										
										<li class="list-group-item"><span class="badge badge-danger pull-right">96</span>cecil98@yahoo.com</li>
									</ul>
								</div>
							</div>
						</div>
