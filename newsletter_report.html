...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (newsletter_report)</title>
    ...
    <body>
		...
		<div id="main_wrapper">
			<div class="page_bar clearfix">
				<div class="row">
					<div class="col-md-8">
						<h1 class="page_title">Report for Halvorson-Emmerich</h1>
			...
			<div class="page_content">
				<div class="container-fluid">
					<div class="row">
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div class="stat_overview">
										<h3><span class="text-danger">3672</span> Recipients</h3>
										<div class="row">
											<div class="col-lg-6 stat_col">
												<span class="text-muted">Subject:</span> Corrupti et et consequatur ducimus. 
												<hr>
												<span class="text-muted">Delivered:</span> 12/03/2014 16:45
											</div>
											<div class="col-lg-6 stat_col">
												<span class="text-muted">Status:</span> <span class="label label-success">successful send</span>
												<hr>
												<a href="#">View Email</a> &middot; <a href="#">Download</a> &middot; <a href="#">Print</a> &middot; <a href="#">Share</a>
											</div>
										</div>
									</div>
									<div id="report_overview" class="chart" style="height:300px;width:100%"></div>
									<script>
										data_opens = [
											[1406988000000,124],
											[1406991600000,114],
						...
						<div class="col-lg-4">
							<div class="panel panel-default">
								<div class="panel-heading">Opens <span class="fa fa-refresh pull-right"></span></div>
								<div class="panel-body">
									<div class="easy_chart easy_chart_opens pull-left" data-percent="81"><span>81,<small>6</small></span></div>
									<div class="easy_chart_desc">
										<h4>4285 Unique opens</h4>
										<p>81,6% of all receipients <a href="#">opened so far</a></p>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">Clicks <span class="fa fa-refresh pull-right"></span></div>
								<div class="panel-body">
									<div class="easy_chart easy_chart_clicks pull-left" data-percent="56"><span>56,<small>2</small></span></div>
									<div class="easy_chart_desc">
										<h4>3312 clicks</h4>
										<p>56,2% <a href="#">clicked a link</a></p>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">Bounces <span class="fa fa-refresh pull-right"></span></div>
								<div class="panel-body">
									<div class="easy_chart easy_chart_bounces pull-left" data-percent="4"><span>4,<small>1</small></span></div>
									<div class="easy_chart_desc">
										<h4>3312 Bounced</h4>
										<p>4,1% <a href="#">couldn't be delivered</a></p>
									</div>
								</div>
							</div>
						</div>
