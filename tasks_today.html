...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (tasks_today)</title>
					...
					<div class="row">
						<div class="col-lg-8">
							...
							<div class="todo_section panel panel-default">
								<div class="todo_date">
									<h4>Today</h4>
									<span class="text-muted">(26.03.2014)</span>
									<div class="pull-right">
										<span class="label label-success td_resolved_tasks">0</span> / <span class="label label-default">14</span>
									</div>
								</div>
								<ul class="todo_list_wrapper">
									<li data-task-title="Non voluptate veniam rerum explicabo eos." data-task-label="business" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a1" id="td_chbox_a1">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_g pull-right">business</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Non voluptate veniam rerum explicabo eos.</a></h5>
									</li>
									<li data-task-title="Molestiae aut veritatis alias aut." data-task-label="family" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a2" id="td_chbox_a2" checked>
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_d pull-right">family</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Molestiae aut veritatis alias aut.</a></h5>
									</li>
									<li class="todo_stared" data-task-title="Sint quo velit eligendi impedit." data-task-label="family" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a3" id="td_chbox_a3">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_d pull-right">family</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Sint quo velit eligendi impedit.</a></h5>
									</li>
									<li data-task-title="Ex velit quasi." data-task-label="family" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a4" id="td_chbox_a4">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_d pull-right">family</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Ex velit quasi.</a></h5>
									</li>
									<li data-task-title="Dolores amet eius placeat consequatur." data-task-label="envato" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a5" id="td_chbox_a5">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_c pull-right">envato</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Dolores amet eius placeat consequatur.</a></h5>
									</li>
									<li data-task-title="Corrupti quis commodi et nihil et." data-task-label="work" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a6" id="td_chbox_a6" checked>
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_a pull-right">work</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Corrupti quis commodi et nihil et.</a></h5>
									</li>
									<li data-task-title="Harum assumenda excepturi quo sunt." data-task-label="envato" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a7" id="td_chbox_a7">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_c pull-right">envato</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Harum assumenda excepturi quo sunt.</a></h5>
									</li>
									<li data-task-title="Ut vitae vitae dicta ad nostrum." data-task-label="work" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a8" id="td_chbox_a8" checked>
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_a pull-right">work</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Ut vitae vitae dicta ad nostrum.</a></h5>
									</li>
									<li data-task-title="Facere fugit quia in." data-task-label="family" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a9" id="td_chbox_a9">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_d pull-right">family</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Facere fugit quia in.</a></h5>
									</li>
									<li data-task-title="Quis iure aut eius quia est." data-task-label="family" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a10" id="td_chbox_a10" checked>
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_d pull-right">family</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Quis iure aut eius quia est.</a></h5>
									</li>
									<li data-task-title="In quibusdam inventore beatae exercitationem." data-task-label="family" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a11" id="td_chbox_a11" checked>
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_d pull-right">family</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">In quibusdam inventore beatae exercitationem.</a></h5>
									</li>
									<li data-task-title="Voluptatem et doloremque dolore quae." data-task-label="" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a12" id="td_chbox_a12">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
																				
										<h5 class="todo_title"><a href="#todo_task_modal">Voluptatem et doloremque dolore quae.</a></h5>
									</li>
									<li class="todo_stared" data-task-title="Eum consequatur id molestiae est qui." data-task-label="" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a13" id="td_chbox_a13">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
																				
										<h5 class="todo_title"><a href="#todo_task_modal">Eum consequatur id molestiae est qui.</a></h5>
									</li>
									<li data-task-title="Soluta laborum quia similique." data-task-label="envato" data-task-date="26.03.2014">
										<div class="todo_checkbox">
											<input autocomplete="off" type="checkbox" name="td_chbox_a14" id="td_chbox_a14">
										</div>
										<div class="todo_star">
											<span class="fa fa-star-o"></span>
										</div>
										<span class="label color_c pull-right">envato</span>										
										<h5 class="todo_title"><a href="#todo_task_modal">Soluta laborum quia similique.</a></h5>
									</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="events_list">
								<div class="events_date clearfix">
									<span class="event_date_big ion-ios7-calendar-outline"><span>25</span></span>
									<span class="event_date_day">Monday</span>
									<span class="event_date_full">May, 25 2014 </span>
								</div>
																<div class="event_item">
									<div class="event_hour">08:00</div>
									<ul class="event_content">
										<li>
											<p>Aut neque dolor iure.</p>
											<span>business</span>										
										</li>
										<li>
											<p>Ipsam ut voluptate modi.</p>
											<span>envato</span>										
										</li>
										<li>
											<p>Cumque et et.</p>
								...
								<div class="event_item">
									<div class="event_hour">13:00</div>
									<ul class="event_content">
										<li>
											<p>Ut eum exercitationem id.</p>
																					
										</li>
										<li>
											<p>Itaque maiores aliquid.</p>
											<span>family</span>										
										</li>
										<li>
											<p>Voluptatem ex distinctio qui qui.</p>
											<span>family</span>										
										</li>
										<li>
											<p>Nihil odio eum.</p>
								...
								<div class="event_item">
									<div class="event_hour">15:00</div>
									<ul class="event_content">
										<li>
											<p>Consequatur eum ad commodi.</p>
											<span>envato</span>										
										</li>
										<li>
											<p>Cum animi et.</p>
										...
										<li>
											<p>Ratione similique est.</p>
											<span>envato</span>										
										</li>
										<li>
											<p>Accusamus et est aut.</p>
											<span>business</span>										
										</li>
									</ul>
								</div>
								<div class="event_item">
									<div class="event_hour">18:30</div>
									<ul class="event_content">
										<li>
											<p>Sint omnis laudantium.</p>
											<span>envato</span>										
										</li>
										<li>
											<p>Iusto iusto minus.</p>
											<span>work</span>										
										</li>
									</ul>
								</div>
