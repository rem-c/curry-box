...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (image_zoom)</title>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading">Image Zoom</div>
								<div class="panel-body">
									<div class="row">
										<div class="col-md-4">
											<div class="heading_a">Inner Zoom</div>
											<img class="img-responsive" id="zoom_inner" src="assets/img/examples/image_zoomer_01_tn.jpg" data-zoom-image="assets/img/examples/image_zoomer_01.jpg" alt="inner_zoom"/>
										</div>
										<div class="col-md-4">
											<div class="heading_a">Lens Zoom</div>
											<img class="img-responsive" id="zoom_lens" src="assets/img/examples/image_zoomer_02_tn.jpg" data-zoom-image="assets/img/examples/image_zoomer_02.jpg" alt="lens_zoom"/>
										</div>
									</div>
								</div>
							</div>
	...
	<!-- page specific plugins -->
		...
		<!-- image zoom -->
		<script src="assets/lib/elevatezoom/jquery.elevateZoom-3.0.8.min.js"></script>
		
		<!-- image zoom functions -->
		<script src="assets/js/apps/tisa_zoom.js"></script>
