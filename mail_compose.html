...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (mail_compose)</title>
    ...
    <body>
		...
		<div id="main_wrapper">
			<div class="page_bar clearfix">
				<div class="row">
					<div class="col-lg-10">
						<h1 class="page_title">New message</h1>
						<p class="text-muted">lorem ipsum dolor sit&hellip;</p>
					</div>
				</div>
			</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<input type="text" name="msg_to" id="msg_to" class="form-control msg_select" value="alexis78@heller.info,hgorczany@marvingusikowski.net">
										</div>
										<div class="form-group">
											<label for="msg_cc">Cc</label>
											<input type="text" name="msg_cc" id="msg_cc" class="form-control msg_select">
										</div>
										<div class="form-group">
											<label for="msg_bcc">Bcc</label>
											<input type="text" name="msg_bcc" id="msg_bcc" class="form-control msg_select">
										</div>
										...
										<div class="form-group">
											<button class="btn btn-xs btn-link" type="button"><span class="fa fa-plus"></span> Add files</button>
										</div>
										<div class="form-group">
											<textarea name="msg_content" id="msg_content" cols="30" rows="12" class="form-control"></textarea>
										</div>
										<div class="form-group form-sep">
											<button type="button" class="btn btn-success btn-sm"><span class="fa fa-envelope-o"></span> Send</button>
											<button type="button" class="btn btn-default btn-sm"><span class="fa fa-save"></span> Save Now</button>
											<button type="button" class="btn btn-link btn-sm"><span class="fa fa-times"></span> Discard</button>	
										</div>
									</div>
								</div>
							</div>
