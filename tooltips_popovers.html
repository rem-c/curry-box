...
<html>
    <head>
		<meta charset="UTF-8">
		<title>Tisa Admin Template v1.1 (tooltips_popovers)</title>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading">PowerTip Tooltips</div>
								<div class="panel-body text-center">
									<div class="row">
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<button class="pTip_top_left btn btn-sm btn-default" title="Top Left placement">Top Left</button>
												</div>
												<div class="col-md-4">
													<button class="pTip_top btn btn-sm btn-default" title="Top Center placement">Top Center</button>
												</div>
												<div class="col-md-4">
													<button class="pTip_top_right btn btn-sm btn-default" title="Top Right placement">Top Right</button>
												</div>
											</div>
											<div class="row">
												<div class="col-md-4">
													<button class="pTip_left btn btn-sm btn-default" title="Left placement">Center Left</button>
												</div>
												<div class="col-md-4 col-md-offset-4">
													<button class="pTip_right btn btn-sm btn-default" title="Right placement">Center Right</button>
												</div>
											</div>
											<div class="row">
												<div class="col-md-4">
													<button class="pTip_bottom_left btn btn-sm btn-default" title="Bottom Left placement">Bottom Left</button>
												</div>
												<div class="col-md-4">
													<button class="pTip_bottom btn btn-sm btn-default" title="Bottom placement">Bottom Center</button>
												</div>
												<div class="col-md-4">
													<button class="pTip_bottom_right btn btn-sm btn-default" title="Bottom Right placement">Bottom Right</button>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="well sepH_b pTip_follow_mouse" title="followMouse option set to true">The tooltip for this box will follow the mouse.</div>
											<div class="well sepH_b pTip_mouse_on">The tooltip for this box will appear on the left and you will be able to interact with its content.</div>
										</div>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-3">
											<button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="top" data-title="A Title" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Show popover (click)</button>
										</div>
										<div class="col-md-3">
											<button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="top" data-title="A Title" data-trigger="hover" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Show popover (hover)</button>
										</div>
									</div>
									<div class="row">
										<div class="col-md-3">
	...
	<!-- page specific plugins -->
		...
		<!-- power tooltips -->
		<script src="assets/lib/powertip/jquery.powertip.min.js"></script>
		
		<!-- tooltips, popovers functions -->
		<script src="assets/js/apps/tisa_tooltips.js"></script>
